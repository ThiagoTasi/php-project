        ...
        <div class="alert alert-info">
            <form action="usuarios_atualiza.php" name="form_atualiza" id="form_atualiza" method="POST" enctype="multipart/form-data">
                ...
                <div class="input-group">
                    ...
                    <input type="password" name="senha" id="senha" maxlength="8" placeholder="Digite a NOVA senha desejada." class="form-control" required autocomplete="off" value="<?php echo $userrow['senha']; ?>">
                </div><!-- fecha input-group -->
                <br>
                <!-- fecha input senha -->
