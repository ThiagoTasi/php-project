...
$busca = $_GET['buscar'];
$listaBusca = $pdo->query("select * from vw_produtos where descricao like '%$busca%' or resumo like '%$busca%' order by descricao asc ");
$linhaBusca = $listaBusca->fetch(PDO::FETCH_ASSOC);
$numLinhas = $listaBusca->rowCount();
...
<body class="fundofixo">
    ...
    <div class="container">
        ...
        <?php do{ ?>
            ...
            <?php } while($linhaBusca =  $listaBusca->fetch(PDO::FETCH_ASSOC));?>
        </div>
        <?php } ?>
    </div>
